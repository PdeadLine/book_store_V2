...
$(function() {
  ...
  <div id="show">
    ...
    <img align="top" src="<c:url value='/${book.image }'/>" class="tp"/>
    <div id="book" style="float:left;">
	    <ul>
	    	<li>商品编号：${book.bid }</li>
	    	<li>当前价：<span class="price_n">&yen;40.7</span></li>
	    	<li>定价：<span style="text-decoration:line-through;">&yen;${book.price }</span>　折扣：<span style="color: #c30;">6.9</span>折</li>
	    </ul>
   ...
   <form action="<c:url value='/admin/AdminBookServlet'/>" method="post" id="form">
    ...
    <div style="float:left;">
		...
		<table class="tab">
			...
			<tr>
				<td>
					一级分类：<select name="cid" id="cid" onchange="loadChildren()">
