...
<html>
  ...
  <div>
    <img align="top" src="<c:url value='/${book.image }'/>" class="img_image_w"/>
    <div class="divBookDesc">
	    <ul>
	    	<li>商品编号：4A9574F03A6B40C1B2A437237C17DEEC</li>
	    	<li>传智价：<span class="price_n">&yen;${book.price }</span></li>
	    	<li>定价：<span class="spanPrice">&yen;${book.price }</span>　折扣：<span style="color: #c30;">6.9</span>折</li>
	    </ul>
		<hr class="hr1"/>
		<table>
			<tr>
