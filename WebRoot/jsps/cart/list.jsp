...
<c:forEach items="${sessionScope.cart.cartItems }" var="cartItem">
	<tr align="center">
		...
		<td align="left" width="70px">
			<a class="linkImage" href="<c:url value='/jsps/book/desc.jsp'/>"><img border="0" width="54" align="top" src="<c:url value='/${cartItem.book.image }'/>"/></a>
		</td>
		<td align="left" width="400px">
		    <a href="<c:url value='/jsps/book/desc.jsp'/>"><span>${cartItem.book.bname }</span></a>
		</td>
		<td><span>&yen;<span class="currPrice" id="12345CurrPrice">${cartItem.book.price }</span></span></td>
		<td>
			<a class="jian" id="12345Jian">${cartItem.count }</a><input class="quantity" readonly="readonly" id="12345Quantity" type="text" value="1"/><a class="jia" id="12345Jia"></a>
		</td>
		<td width="100px">
	...
	<tr>
		<td colspan="4" class="tdBatchDelete">
			<a href="<c:url value='/CartServlet?method=clear'/>">批量删除</a>
		</td>
		<td colspan="3" align="right" class="tdTotal">
			<span>总计：</span><span class="price_t">&yen;<span id="total">${sessionScope.cart.total }</span></span>
		</td>
	</tr>
	<tr>
		<td colspan="7" align="right">
			<a href="<c:url value='/OrderServlet?method=add'/>" id="jiesuan" class="jiesuan"></a>
		</td>
	</tr>
</table>
