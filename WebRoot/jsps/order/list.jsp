...
<c:forEach items="${orderList }" var="order">
		...
		<tr class="tt">
			<td width="320px">订单号：${order.oid }<a  href="<c:url value='/jsps/order/desc.jsp'/>">E3A1EB6D0543489F9729B2B5BC5DB365</a></td>
...
<c:forEach items="${order.orderItemList }" var="orderItem">
	<a class="link2" href="<c:url value='/BookServlet?method=load&bid=${orderItem.book.bid }'/>">
	    <img border="0" width="70" src="<c:url value='/${orderItem.book.image }'/>"/>
	</a>
...
<!-- 
 ...
 -->
			...
			<a href="<c:url value='/jsps/order/desc.jsp'/>">查看</a><br/>
				...
				<a href="<c:url value='/OrderServelt?method=load&oid=${order.oid }'/>">支付</a><br/>
